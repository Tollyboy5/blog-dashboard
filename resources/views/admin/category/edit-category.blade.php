        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active"><span><i class='far fa-edit'></i></span> EDIT CATEGORY</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
    ...
    <section class="content">
      <div class="container-fluid">
        ...
        <div class="card card-default">
          ...
          @endif
          <form action="{{ url('admin/edit-category/'.$cate->id) }}" method="post" enctype="multipart/form-data">
            @csrf
            @method('PUT')
