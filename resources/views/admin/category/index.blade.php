...
<div class="content-header">
    <div class="container-fluid">
      <div class="row mb-2">
        <div class="col-sm-6">
          <h1 class="m-0 text-muted">CATEGORY</h1>
        </div><!-- /.col -->
        @if (session('status'))
        ...
        <table class="table table-bordered">
          ...
          <tbody>
            ...
            <tr>
              ...
              <td> <a href="{{ url('admin/edit-category/'.$cate->id) }}" class="btn btn-secondary">Edit</a></td>
              <td> <a href="{{ url('admin/delete-category/'.$cate->id) }}" class="btn btn-secondary">Delete</a></td>
            </tr>
            @endforeach
          </tbody>
        </table>
