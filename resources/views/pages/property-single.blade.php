            ...
            <div id="property-single-carousel" class="swiper">
              <div class="swiper-wrapper">
                <div class="carousel-item-b swiper-slide">
                  <img src="{{ asset('assets/images/img/slide-1.jpg') }}" alt="">
                </div>
                <div class="carousel-item-b swiper-slide">
                  <img src="{{ asset('assets/images/img/slide-2.jpg') }}" alt="">
                </div>
              </div>
            </div>
          ...
          <div class="col-md-10 offset-md-1">
            ...
            <div class="tab-content" id="pills-tabContent">
              ...
              <div class="tab-pane fade" id="pills-plans" role="tabpanel" aria-labelledby="pills-plans-tab">
                <img src="{{ asset('assets/images/img/plan2.jpg') }}" alt="" class="img-fluid">
              </div>
          ...
          <div class="col-md-12">
            ...
            <div class="row">
              <div class="col-md-6 col-lg-4">
                <img src="{{ asset('assets/images/img/agent-4.jpg') }}" alt="" class="img-fluid">
              </div>
              <div class="col-md-6 col-lg-4">
